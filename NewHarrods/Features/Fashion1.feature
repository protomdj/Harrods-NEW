...
Scenario Outline: Multiple variants available
  Given I am on a Fashion1 PDP with multiple <variants> 
  ...
  Scenario: Product with no variants
  Given I am on a Fashion1 PDP with no available variants
  Then no variants are displayed

Scenario: Add in-stock product to bag 
  Given I am on a Fashion1 PDP
...
Scenario: All variants are OOS
  Given I am on a Fashion1 PDP with colour and size variants
...
Scenario: Product associations
  Given I am on a Fashion1 PDP which has product associations
...
Scenario: Size guide 
  Given I am on a Fashion1 PDP with a size guide
  ...
  Given I am on a Fashion1 PDP which has fit notes
  When I open the size guide module
...
Scenario: Delivery & Returns 
  Given I am on a Fashion1 PDP with delivery & returns
